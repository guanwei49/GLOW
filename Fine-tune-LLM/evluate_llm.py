...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='/home/weiguan/llmmodel/Qwen3-1.7B', help='Path to the LLM model')
    parser.add_argument('--lora_path', type=str, default='/home/weiguan/GLOW/outputs/Coding-GD', help='Path to the lora model')
